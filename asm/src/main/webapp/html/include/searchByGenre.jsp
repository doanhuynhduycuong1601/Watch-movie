...
<div class="container">
	<div class="row mb-5">
		<div class="offset-1 col-3">
			<img style="height: 220px; width: 250px" class="row"
				src="/asm/img/imggenre/${genreDetail.img}">
		</div>
		<div class="col-8">
			<div class="row">
				<label class="row mb-3 text-light">Name :
					${genreDetail.names}</label> <label class="row mb-3 text-light">Description
					: ${genreDetail.descriptions}</label>
			</div>
		</div>
	</div>
	<div class="row mb-4">
		<c:url var="url" value="/search/genre/${id}/"></c:url>
		...
		<div class="row">
			<div class="col-6 offset-3">
				<c:if test="${pageCurrent > 1}">
					<a href="${url}1" class="btn btn-outline-secondary"><i
				...
				<c:if test="${pageLast - pageCurrent >= 1}">
					<a href="${url}${pageLast}" class="btn btn-outline-secondary"><i
