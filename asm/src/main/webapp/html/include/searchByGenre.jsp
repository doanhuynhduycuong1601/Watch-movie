...
<div class="row mb-5">
	<div class="col-4">
		<img style="height: 220px;width: 250px" class="row" src="/asm/img/imggenre/${genreDetail.img}">
	</div>
	<div class="col-8">
		<div class="row">
					<label class="row mb-3 text-light">Name : ${genreDetail.names}</label> 
						<label class="row mb-3 text-light">Description : ${genreDetail.descriptions}</label>
				</div>
	</div>
</div>
<div class="row mb-4">
